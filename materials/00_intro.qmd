...
\placefig{0.5}{5.9}{width=2.5cm}{debra}
\begin{textblock}{11.5}(3.5,6.4)
  \begin{alertblock}{Debra Okeh}
    {\small
      \href{https://x.com/DebraOkeh}{\faIcon{twitter} x.com/DebraOkeh}\\
      \href{https://www.linkedin.com/in/debra-okeh-1500ab109/}{\faIcon{linkedin} debra-okeh-1500ab109}
    }
  \end{alertblock}
\end{textblock}
...
## Schedule for each session (UK time zone)
