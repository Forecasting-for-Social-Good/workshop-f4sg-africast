...
2. Past and future data about deterministic predictors
3. Past and future data about stochastic predictors
4. Expertise of individuals in an organization and any contextual information that may affect the forecast variable
    + New information


```{r forecasting, out.width="70%", fig.align='center'}
...
## Why does an organisation need forecasting?
